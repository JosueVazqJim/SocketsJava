...
public class Frm2 extends JDialog implements Observer {
    ...
    public Frm2() {
        ...
        Servidor s = new Servidor(6000); //creamos un servidor en el puerto 5000
    ...
    private void onOK() {
        String mensaje = "2: "+this.textField1.getText()+"\n";

        this.textArea1.append(mensaje);

        Cliente c = new Cliente(5000, mensaje); //creamos un cliente en el puerto 6000
